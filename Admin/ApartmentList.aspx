...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div>
		<asp:Label ID="lblOrder" runat="server" Text="Sortiraj po:"></asp:Label>
	...
	<asp:GridView ID="gvListaApartmana" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-condensed table-hover">
		<Columns>
			...
			<asp:BoundField DataField="OccupierUsername" HeaderText="Rezervirao/la" />
			...
			<asp:TemplateField HeaderText="Administracija" ItemStyle-Width="400px">
				<ItemTemplate>
					<asp:HyperLink ID="hlEditor" runat="server" CssClass="btn btn-primary mb-1" Text="Uredi" NavigateUrl='<%# Eval("Id", "ApartmentEditor.aspx?Id={0}") %>'></asp:HyperLink>
					<asp:HyperLink ID="hlDelete" runat="server" CssClass="btn btn-danger" Text="Izbriši" NavigateUrl='<%# Eval("Id", "ApartmentDelete.aspx?Id={0}") %>'></asp:HyperLink>
				</ItemTemplate>
			</asp:TemplateField>
